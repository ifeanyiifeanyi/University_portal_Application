                    ...
                    <div class="card student-profile-card">
                        ...
                        <div class="card-body">
                            <div class="text-center mb-4">
                                <img src="{{ $student->user->profileImage() }}" alt="Student Picture"
                                    class="rounded-circle profile-picture">
                                <h4 class="mt-3">{{ $student->user->first_name }} {{ $student->user->last_name }}
                                    {{ $student->user->other_name }}</h4>
                        ...
                        <p><strong>Current Level:</strong> {{ $student->department->getDisplayLevel($student->current_level) }}</p>
