...
@section('student')
                    ...
                    <div class="card-body pt-3">
                        ...
                        <form action="{{ route('student.view.fees.process') }}" method="POST">
                                    ...
                                    <select name="academic_session_id" id="" class="form-control">
                                        ...
                                        @foreach ($academicsessions as $academicsession)
                                            <option value="{{ $academicsession->id }}"
                                                {{ $academicsession->is_current ? 'selected' : '' }}>
                                                {{ $academicsession->name }}
                                                {{ $academicsession->is_current ? '(Current Session)' : '' }}
                                            </option>
                                        @endforeach
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <output
                                        class="form-control">{{ $student->department->getDisplayLevel($student->current_level) }}</output>
                                    <input type="hidden" name="level" id=""
                                        value="{{ $student->department->getLevelNumber($student->current_level) }}">
                                </div>
                            </div>
                            {{-- <div class="row mb-3">
    ...
    @endif
                                    ...
                                    <select name="semester_id" id="" class="form-control">
                                        ...
                                        @foreach ($semesters as $semester)
                                            <option value="{{ $semester->id }}"
                                                ...
                                                {{ $semester->name }}
                                                {{ $semester->is_current ? '(Current Semester)' : '' }}
                                            </option>
                                        @endforeach
                            ...
                            <div id="installment-options" class="row mb-3" style="display: none;">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="is_installment" value="1"
                                            id="is_installment">
                            ...
                            <div>
                                <button class="btn w-50 text-white btn-success" style=""
                                    onclick="return confirm('Are you sure you want to proceed with this payment?')">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
