                            ...
                            <div class="col-md-3">
                                ...
                                <select name="status" class="form-select">
                                    ...
                                    @foreach ($academicSessions as $session)
                                        <option value="{{ $session->name }}" {{ $session->is_current ? 'selected' : '' }}>
                                            {{ $session->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="priority" class="form-select">
                                    ...
                                    @foreach ($semesters as $semester)
                                        <option value="{{ $semester->name }}" {{ $semester->is_current ? 'selected' : '' }}>
                                            {{ $semester->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $payment->academicSession->name }} <br> {{ $payment->semester->name }}</td>
