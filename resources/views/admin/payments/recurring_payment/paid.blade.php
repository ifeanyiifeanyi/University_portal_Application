                    ...
                    <div class="card-header bg-gradient-primary text-white py-3">
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                            ...
                            <div class="d-flex flex-wrap gap-2 align-items-center">
                                <form method="GET" action="{{ route('admin.recurring_payments.get-recurring-payments') }}"
                                    class="d-flex">
                                    <div class="input-group input-group-sm">
                                        <span class="input-group-text bg-white border-end-0">
                                            <i class="fas fa-calendar-alt text-primary"></i>
                                        </span>
                                        <select name="year" class="form-select form-select-sm border-start-0 ps-0"
                                        ...
                                        <div class="card-body p-3">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <h5 class="fw-bold text-secondary mb-0">
                                                    ₦{{ number_format($total['total'], 2) }}</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <table id="payment-table" class="table table-hover align-middle mb-0">
                                <thead class="bg-light">
                                    <tr>
                                        ...
                                        <th class="px-3 py-2 text-uppercase text-secondary fw-semibold fs-7">Student Name
                                        </th>
                                        <th class="px-3 py-2 text-uppercase text-secondary fw-semibold fs-7">Level</th>
                                        <th class="px-3 py-2 text-uppercase text-secondary fw-semibold fs-7">Amount Paid
                                        </th>
                                        <th class="px-3 py-2 text-uppercase text-secondary fw-semibold fs-7">Months</th>
                                        <th class="px-3 py-2 text-uppercase text-secondary fw-semibold fs-7">Payment Date
                                        </th>
                                        <th class="px-3 py-2 text-uppercase text-secondary fw-semibold fs-7">Covered Period
                                        </th>
                                    </tr>
                                </thead>
                                    ...
                                    @forelse($students as $payment)
                                        <tr>
                                            ...
                                            <td class="px-3 py-2 fw-medium">
                                                ...
                                                <small class="text-muted">{{ $payment['email'] }},
                                                    {{ $payment['phone_number'] }}</small>
                                            </td>
                                            ...
                                            <td class="px-3 py-2 text-center">
                                                <span class="badge bg-secondary rounded-pill">
                                                    ...
                                                    month{{ $payment['number_of_months'] > 1 ? 's' : '' }}
                                                </span>
                                            </td>
                                            <td class="px-3 py-2">
                                        ...
                                        <tr>
                                            <td colspan="6" class="text-center py-5">
                                                <div class="d-flex flex-column align-items-center">
                                                    <i class="fas fa-file-invoice-dollar text-secondary mb-3"
                                                        style="font-size: 3rem;"></i>
                                                    <h5 class="text-secondary">No payments found for {{ $year }}
                                                    </h5>
                ...
                if (e.target.value) {
                    if (!e.target.parentNode.querySelector('.clear-search')) {
                        ...
                        clearButton.className =
                            'position-absolute end-0 top-0 bottom-0 d-flex align-items-center pe-2 clear-search';
