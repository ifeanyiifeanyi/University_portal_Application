    ...
    <div class="row g-4">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                ...
                                <input type="text" id="searchInput" class="form-control"
                                       placeholder="Search by department, semester or level...">
                            </div>
                        </div>
                        <div class="col-md-4">
                                            ...
                                            <tr class="assignment-row">
                                                ...
                                                <td class="text-end">
                                                    <div class="btn-group btn-group-sm">
                                                        ...
                                                        <form onsubmit="return confirm('Are you sure you want to delete this assignment?')"
        ...
        <div class="col-lg-3">
            <div class="card shadow-sm border-info">
                ...
                <div class="card-body">
                    <p class="card-text">
                        This section manages the maximum credit hours students can register per semester. Each assignment is specific to a department, academic level, and semester combination.
                    </p>
