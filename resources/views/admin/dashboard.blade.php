                        ...
                        <table class="table align-middle mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ \App\Models\Payment::whereDate('created_at', \Carbon\Carbon::today())->count() }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="table-responsive mt-3">
                        <table class="table align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>Score Updates</td>
                                    <td>{{ \App\Models\StudentScore::whereDate('created_at', \Carbon\Carbon::today())->count() }}</td>
                                    <td>{{ \App\Models\StudentScore::count() }}</td>
                                </tr>
                                <tr>
                                    <td>Attendance Records</td>
                                    <td>{{ \App\Models\Attendance::whereDate('created_at', \Carbon\Carbon::today())->count() }}</td>
                                    <td>{{ \App\Models\Attendance::count() }}</td>
                                </tr>
                                <tr>
                                    <td>Teacher Assignments</td>
                                    <td>{{ \App\Models\TeacherAssignment::whereDate('created_at', \Carbon\Carbon::today())->count() }}</td>
