            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <th><a href="{{route('teacher.create.attendance',['sessionid'=>$coursesassigned->academicSession->id,'semesterid'=>$coursesassigned->semester->id,'departmentid'=>$coursesassigned->department->id,'courseid'=>$coursesassigned->course->id])}}" class="btn w-100 btn-success" style="color: #ffffff">Take attendance</a></th>
                </tr>
                @empty
