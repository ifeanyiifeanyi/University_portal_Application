<form action="{{route('teacher.create.profile')}}" method="POST" id="requestForm">
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9">
      <input name="teaching_experience" type="number" class="form-control" value="{{old('teaching_experience')}}">
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9">
      <input name="date_of_employment" type="date" class="form-control" value="{{old('date_of_employment')}}">
