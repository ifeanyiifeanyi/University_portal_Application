...
<form action="{{ route('teacher.update.profile') }}" method="POST" id="requestForm">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-8 col-lg-9">
            <select name="teacher_level" class="form-control">
                ...
                <option value="Faculty_officer" @if ($profile->level == 'Faculty_officer') selected @endif>Faculty officer
                </option>
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-8 col-lg-9">
            ...
            <input name="number_of_awards" type="number" class="form-control"
                value="{{ $profile->number_of_awards }}">
